...
//echo $_FILES['logo']['name']; exit;

if($_FILES['logo']['name']!='')
{
$wlogo=addslashes($_FILES['logo']['name']);
move_uploaded_file($_FILES['logo']['tmp_name'],"../uploads/logo/".$wlogo);
$logoqry=",gen_logo='$wlogo'";
}
else
{
$logoqry='';
...
//echo "update mlm_generalsetting set gen_title='$wtitle',gen_keywords='$wkey',gen_desc='$wdes',gen_sitename='$wname', gen_team='$wteam',gen_mail='$wadmin',gen_url='$wurl',gen_paypal='$wpayid' $logoqry where gen_id ='1'"; exit;

$qry=mysql_query("update mlm_generalsetting set gen_title='$wtitle',gen_keywords='$wkey',gen_desc='$wdes',gen_sitename='$wname', gen_team='$wteam',gen_mail='$wadmin',gen_url='$wurl', gen_paypal='$wpayid' $logoqry where gen_id ='1'");
...
echo "<script>window.location='setting.php?suss';</script>";
	 ...
	 var team = document.getElementById('team').value;
	  var email = document.getElementById('email').value;
	   var url = document.getElementById('url').value;
		 var payid = document.getElementById('paypal').value;
 ...
 if(title == "")
  ...
  if(payid == "")
	{
		alert("Enter the Website Paypal id");
...
-->								<!--<input type="submit" name="submit" value="SUBMIT" class="btn btn-info" style="font-weight:bold;">-->
								<input type="button"  value="SUBMIT" class="btn btn-info" style="font-weight:bold;" onclick="alert('This feature is disabled for demo version');">	
									...
									<input type="reset" name="reset" value="RESET" class="btn" style="font-weight:bold;">
										<br />This feature is disabled for demo version
								</div>
