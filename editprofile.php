...
if(isset($_REQUEST['update1']))
{
	//echo "testting";
	$uid=$_SESSION['userid'];
	$pancard=addslashes($_REQUEST['user_pancard']);
...
if(isset($_REQUEST['update3']))
{
	...
	$insert=mysql_query("update mlm_register set user_nomineename='$nname',user_identifycardtype='$nct',user_idnumber='$ncnumber',user_naddr1='$naddr1',user_naddr2='$naddr2',user_ncity='$ncity',user_nstate='$nstate',user_ncountry='$ncountry',user_npostalcode='$nzipcode',user_nphone='$nphone',user_nemail='$nemail' where user_id='$uid'");
...
<input class="input-block-level"  style="width:70px; margin-bottom:16px;"type="text" placeholder="YYYY" name="dobyear" id="dobyear" value="<?php echo $yr; ?>" required="true" />
						...
						<div class="controls" id="astate">
							...
							<td align="center">:</td>
							<td>
							<select  name="cpcountry" id="cpcountry" onchange="return stateview(this.value);" required="true">
									<option value="">--- Choose Country ---</option>
									<?php 
				...
				<div class="controls" id="cpstatee">
							<select  name="cpstate" id="cpstate" onchange="return cityview(this.value);" required="true">
                             <option value="">--- Choose State ---</option>
							 <?php
		...
		?>
						...
						<select  name="cppcity" id="cppcity" required="true">
                             <option value="">--- Choose City ---</option>
							 <?php
