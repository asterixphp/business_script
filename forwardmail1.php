                    ...
                    <div class="row">
                        <div class="span9">
							<div class="banner" style="padding-right: 0;">
								<h4 class="navbar-inner" style="color:#fff; line-height:40px; margin-top: -50px; margin-bottom: 7px;">Forward Mail (to Admin)</h4>
							<form action="" method="post" onClick="return composseval();">
                                <table cellpadding="7" cellspacing="0" border="0" width="100%">
									...
									<?php } ?>
										...
										<tr>
										<td colspan="3">
										<input type="hidden" name="type" id="type1" value="1" onClick="typval('1');">
										</td>
									</tr>
