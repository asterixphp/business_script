...
?>
    ...
    <body>
		<div class="container main">
            ...
            <div class="form3">
            <div class="span5">
                        <div class="span7" style="width:600px; min-height:400px; height:auto;">
						<h1>Download Document</h1>
                       
					   <?php
					   $docdown=mysql_query("select * from mlm_document where doc_status='0'");
					   $i=1;
					   while($row_doc=mysql_fetch_array($docdown))
					   {
					    ?>
