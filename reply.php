...
$rpval=mysql_fetch_array(mysql_query("select * from mlm_outbox where outbox_id='$_REQUEST[rep]'"));
                    ...
                    <div class="row">
                        <div class="span9">
							<div class="banner" style="padding-right: 0;">
								<h4 class="navbar-inner" style="color:#fff; line-height:40px; margin-top: -50px; margin-bottom: 7px;">Reply Mail</h4>
